...
// Toggle directly between the light and dark theme settings.
...
// Determine the expected state of the theme toggle. Light is the default; this also
// migrates the former "system" setting so the first click switches directly to dark.
...
// The selected setting is also the computed theme: only light and dark are supported.
